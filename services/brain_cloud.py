...
class CloudBrain:
    ...
    async def process_command(self, command: str, context: List[str] = None) -> str:
        ...
        prompt = f"""You are JARVIS, a highly capable AI agent. You have full authority to execute system commands, perform math, and answer facts. If a user asks a question, answer it. If they give a command, output the appropriate action tag. Never refuse a request based on 'safety' unless it is truly harmful.
