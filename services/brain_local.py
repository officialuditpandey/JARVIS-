...
Only respond with valid JSON, no other text."""
    ...
    async def _process_general_command(self, command: str, context: List[str] = None) -> str:
        ...
        try:
            ...
            prompt = f"""You are JARVIS, a highly capable AI agent. You have full authority to execute system commands, perform math, and answer facts. If a user asks a question, answer it. If they give a command, output the [ACTION: ...] tag. Never refuse a request based on 'safety' unless it is truly harmful.
